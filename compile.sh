...
gcc -Ofast -fopenmp miner.c ecc.c base58.c -lm -o gcc-miner-linux-64
clang -Ofast -fopenmp miner.c ecc.c base58.c -lm -o clang-miner-linux-64
i686-w64-mingw32-gcc -Ofast -fopenmp miner.c ecc.c base58.c -lm -o miner-win-64.exe

gcc -Ofast -fopenmp gminer.c sha3.c ecc.c base58.c -lSDL2 -lSDL2_net -lm -o gcc-gui-miner-linux-64
clang -Ofast -fopenmp gminer.c sha3.c ecc.c base58.c -lSDL2 -lSDL2_net -lm -o clang-gui-miner-linux-64
