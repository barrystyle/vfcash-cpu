...
i686-w64-mingw32-gcc -Ofast -fopenmp miner.c ecc.c base58.c -lm -o bin/miner-win-64.exe
...
i686-w64-mingw32-gcc -Ofast -fopenmp gminer.c sha3.c ecc.c base58.c -lSDL2 -lSDL2_net -lm -o bin/gui-miner-win-64.exe
